...
import { Reveal, StaggerContainer, StaggerItem, CountUp, AnimatedButton } from "@/components/animations";
          ...
          <div className="mx-auto max-w-7xl px-4 pb-14 pt-12 sm:px-6 sm:pt-16 lg:px-8">
            ...
            <div className="relative mx-auto mt-7 max-w-4xl">
              ...
              <div className="relative rounded-[28px] border border-orange-100 bg-white p-4 shadow-[0_28px_80px_rgba(172,65,24,0.14)] sm:p-6">
                {/* PasteLink đã có animation riêng, giữ nguyên */}
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <div className="relative flex-1">
                      ...
                      <motion.input
                        ...
                        whileFocus={{ scale: 1.02, boxShadow: "0 0 0 4px #f9731680" }}
                        transition={{ duration: 0.2 }}
                      />
                    </div>
                    <motion.button
                          ...
                          <>
                            ...
                            <div>
                              ...
                              <div className="flex flex-col gap-2 sm:flex-row">
                                ...
                                <motion.button type="button" onClick={handleCopy} className="btn-secondary text-sm whitespace-nowrap" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                  {copied ? "Đã copy ✓" : "Copy short link"}
                                </motion.button>
                                <motion.a href={preview.shortUrl} target="_blank" rel="noreferrer" className="btn-primary text-sm text-center whitespace-nowrap" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
        ...
        <section className="bg-gradient-to-b from-[#fffaf5] to-white py-16 sm:py-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer delay={0.3}>
              <motion.article variants={StaggerItem} className="rounded-[22px] border-2 border-emerald-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)] transition hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(16,185,129,0.12)]" whileHover={{ y: -4 }}>
                <span className="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-extrabold text-emerald-700">
                  Thành viên mới
                </span>
                <h3 className="mt-4 text-xl font-black text-slate-950">
                  Hoàn cao hơn <CountUp target={85} />
                </h3>
                <p className="mt-3 text-sm leading-7 text-slate-500">
                  3 đơn đầu trong <b>14 ngày</b> sau đăng ký: nhận{" "}
                  <b className="text-emerald-600"><CountUp target={85} /></b> tiền hoàn, thay vì mức thường.
                </p>
                <Link
                  href="/register"
              ...
              <motion.article variants={StaggerItem} className="rounded-[22px] border-2 border-orange-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)] transition hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(249,115,22,0.12)]" whileHover={{ y: -4 }}>
                ...
                <p className="mt-3 text-sm leading-7 text-slate-500">
                  ...
                  <b className="text-[#ee4d2d]">+10.000đ</b>. Mỗi cặp nhận một lần.
                </p>
                <Link
              ...
              <motion.article variants={StaggerItem} className="rounded-[22px] border-2 border-violet-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)] transition hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(139,92,246,0.12)]" whileHover={{ y: -4 }}>
            ...
            <Reveal>
              <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#fff0e8] via-[#fff9f5] to-[#ffedd5] px-6 py-10 sm:px-10 lg:grid lg:grid-cols-[1fr_0.85fr] lg:items-center lg:px-14 lg:py-14">
                ...
                <div className="relative mt-10 grid grid-cols-2 gap-4 lg:mt-0 lg:pl-12">
                  <motion.div 
                    className="float-soft rounded-3xl bg-white p-5 shadow-[0_20px_50px_rgba(147,67,30,0.12)]"
                    whileHover={{ y: -4, scale: 1.02 }}
                  >
                    <p className="text-3xl font-black text-[#ee4d2d]"><CountUp target={20} /></p>
                    <p className="mt-2 text-xs font-bold leading-5 text-slate-600">
                      Hoa hồng từ người bạn mời trực tiếp
                    </p>
                  </motion.div>
                  <motion.div 
                    className="mt-8 rounded-3xl bg-[#172033] p-5 text-white shadow-xl"
                    whileHover={{ y: -4, scale: 1.02 }}
                  >
                    <p className="text-3xl font-black text-orange-300"><CountUp target={10} /></p>
